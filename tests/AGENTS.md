...
- `browser-stage-diagnostics.test.ts` - phase-aware browser evidence,
  responsibility classification, timeout content salvage, aggregate
  reconciliation, and historical pre-browser regression coverage.
